...
```js reference
https://github.com/keypom/keypom-js/blob/90ee5677f8d89540690544a4348f431d549db0c4/docs-examples/keypom-js-sdk/ft-example.js#L9-L43
```
:::note
...
```js reference
https://github.com/keypom/keypom-js/blob/90ee5677f8d89540690544a4348f431d549db0c4/docs-examples/keypom-js-sdk/ft-example.js#L45-L68
```
...
```js reference
https://github.com/keypom/keypom-js/blob/90ee5677f8d89540690544a4348f431d549db0c4/docs-examples/near-api-js/ft-near-example.js#L47-L79
```
...
```js reference
https://github.com/keypom/keypom-js/blob/90ee5677f8d89540690544a4348f431d549db0c4/docs-examples/keypom-js-sdk/ft-example.js#L70-L79
```
...
```js reference
https://github.com/keypom/keypom-js/blob/90ee5677f8d89540690544a4348f431d549db0c4/docs-examples/keypom-js-sdk/ft-example.js#L1-L84
```
...
```js reference
https://github.com/keypom/keypom-js/blob/90ee5677f8d89540690544a4348f431d549db0c4/docs-examples/near-api-js/ft-near-example.js#L1-L125
```
...
```
From there, you can open the `ft-example.js` file.
...
```
:::note
The SDK script is being tested here; use `yarn ft-near` to test the `NEAR-API-JS` script instead.
:::
