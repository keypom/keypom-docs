...
To view the completed code, clone the Keypom Docs examples repo and navigage to the `basic-tutorials/ft-drop`.
``` bash
...
```
:::note
The SDK script is being tested here; use `yarn basic:ft-near` to test the `NEAR-API-JS` script instead.
:::
